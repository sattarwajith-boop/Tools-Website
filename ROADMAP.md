...
### Grammar Checker
- Add sentence-by-sentence highlighting inside the text area or preview.
- Add an “Accept all fixes” button.
- Export corrected text as `.docx` or `.txt`.
...
### Resume Builder
- Add multiple templates: minimal, modern, classic, academic.
- Add a skills proficiency visualizer.
- Export directly to PDF.
- Add a LinkedIn-style summary helper.

### Image Collage Maker
- Add drag-to-reorder photos.
- Add text overlays and captions.
- Add filters such as vintage, sepia, bright, and high contrast.

### Thumbnail Creator
- Add a font picker.
- Add shape overlays such as arrows, badges, and frames.
...
- Add a 50/30/20 rule checker.
- Export as CSV or PDF.

### Unit Converter
- Add cooking measurements.
- Add fuel efficiency conversions.
- Add currency conversion only when a reliable exchange-rate API is configured.
